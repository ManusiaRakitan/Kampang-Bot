...
async def _(event):
    ...
    if input_str == "eye":
        ...
        animation_chars = [
            ...
            "👁👁\n  👄  =====> Woy, Pakabs?",
            "👁👁\n  👅  =====> Bae Bae Ajakan?",
            "👁👁\n  💋  =====> Ngapain mulai ini goblom?",
            "👁👁\n  👄  =====> Lu Pantek Anjenggg",
            "👁👁\n  👅  =====> Pergi lu asuu",
            "👁👁\n  💋  =====> Gausa Ketawa, Mulut Lu Bau Belerang",
            "👁👁\n  👄  =====> Ga lucu Pantek",
            "👁👁\n  👅  =====> Gua perhatiin lu makin tolol",
            "👁👁\n  💋  =====> Ok pantek 😑",
            "👁👁\n  👄  =====> Gua Pergi Kontol..."
        ]
...
async def _(event):
    ...
    if input_str == "kill":
        ...
        animation_chars = [
            ...
            "------>;(^。^)ノ",
            "(￣ー￣) MATI LU",
            "**Pantek People Berhasil Terbunuh (°̥̥̥̥̥̥̥̥•̀.̫•́°̥̥̥̥̥̥̥)**",
        ]
...
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in (
            "/", "#", "@", "!"):
        await event.edit("Kalian Pedofil({})")
        await asyncio.sleep(0.5)
        await event.edit("Kalian Jelek Doyan Ngewe(_)(_)=D")
        await asyncio.sleep(0.5)
        await event.edit("Kalian LGBT💩")
        await asyncio.sleep(0.5)
        await event.edit("Kalian Jamet👉👌 ")
        await asyncio.sleep(0.5)
        await event.edit("Muka Kalian Jelek🤪")
        await asyncio.sleep(0.5)
        await event.edit("Cita Cita Kalian Jadi Gigolo💦")
        await asyncio.sleep(0.5)
        await event.edit("Gua paling cakep no debat😎")
        await asyncio.sleep(0.5)
        await event.edit("KALIAN SEMUA JAMET PANTEK... 🔥")
